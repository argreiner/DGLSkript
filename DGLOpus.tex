...
\input{chapters/02_GDGL}
\input{chapters/03_GLHDGL}
\input{chapters/04_GLIDGL}
\input{chapters/05_SLGDGL}
\input{chapters/06_Integraltransformationen}
\input{chapters/07_LinearResponse}
\input{chapters/08_NLDGL}
\input{chapters/09_PDGL}
\input{chapters/10_NumerischeMethoden}
\input{chapters/11_Variationsrechnung_A}
\input{chapters/12_Variationsrechnung_B}
\input{chapters/13_Hamilton}
\input{chapters/14_OptimalControl}
