...
$\boldsymbol{\Phi}(0)=\mathbbm{1}$ erfüllt. Wenn aber mit $\boldsymbol{\Phi(t)}$ eine Fundamentalmatrix gefunden ist, dann ist es leicht ein System wie (\ref{eq:InhomSystem}) mit den
...
\begin{equation}
  ...
  \label{eq:LoesInhom}
\end{equation}
Dies erinnert an das Vorgehen bei der Variation der Konstanten.
