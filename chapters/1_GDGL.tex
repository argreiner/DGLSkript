...
\paragraph{Systeme von DGL 1.\ Ordnung}
    Die Gleichungen
		...
		\end{eqnarray*}
		sind die bekannte Räuber-Beute-Gleichungen oder auch Lotka-Volterra-Gleichungen.
	%\item 
\paragraph{	Transformation von Gleichungen höherer Ordnung auf ein System von Gleichungen 1.\ Ordnung}
...
Gegeben die Differentialgleichung in der Form wie in (\ref{eq:DGLVarKoeff}
) dargestellt. Ist $p(t,y)dt+q(t,y)dy$ das vollständige Differential einer Funktion $\mu(y,t)$, d.h.\ ist 
